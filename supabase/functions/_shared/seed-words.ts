...
export const SEED_WORDS: Record<string, string> = {
  ...
  "🎩🍫🏭": "willy wonka",
  "🐼🥋": "kung fu panda",
  // Food/Things' 30 single-emoji entries (both categories, in full) were
  // removed here in step with
  // 20260820180000_delete_single_emoji_words.sql — a single emoji isn't
  // really a "sequence" to decode.
};
